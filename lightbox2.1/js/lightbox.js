...
//	Prev update: Added ability for the caption ("title" attr of link) to be optionally hyperlinked, by throwing in a "rev" attr containing the desired link
// -----------------------------------------------------------------------------------
/*
...
Object.extend(Element, {
	...
	setWidth: function(element,w) {
	   	element = $(element);
    	element.style.width = w + (typeof w == 'string'? "" : "px");
	},
	...
	setMarginLeft: function(element,t) {
	   	element = $(element);
    	element.style.marginLeft = t +"px";
	},
...
Lightbox.prototype = {
	...
	start: function(imageLink) {	
		...
		var overlaywidth = (arrayPageSize[0] > arrayPageSize[2])? arrayPageSize[0] : '100%';
		Element.setWidth('overlay', overlaywidth);
		...
		Element.setMarginLeft('lightbox', arrayPageScroll[0]);
	...
	changeImage: function(imageNum) {	
		...
		imgPreloader.onload=function(){
			restrictdimensions(imgPreloader);
